    ...
    <>
      <nav className="navbar">
        <div className="container navbar-content">
            ...
            >
              ...
              >
                ...
                <span className="logo-subtitle">
                  Salmistas do Caminho Neocatecumenal
                </span>
              </div>
            </Link>
          </div>
          ...
          {}
          <div
            className="navbar-right desktop-only"
            style={{
              gap: "1rem",
            }}
          >
            ...
            <Link
              to="/calibrador"
              className="btn btn-secondary btn-sm calib-btn"
            >
              <Mic2 size={16} />
      ...
      <div className={`mobile-side-menu ${isMobileMenuOpen ? "open" : ""}`}>
        ...
        <div className="mobile-menu-content">
          ...
          >
            <Link
              to="/"
              className="btn btn-secondary mobile-calib-btn"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              <Music size={18} />
              <span>Cantos</span>
          ...
          {user && (
            <div className="mobile-user-section">
              <UserMenuContent user={user} voiceProfile={voiceProfile} />
