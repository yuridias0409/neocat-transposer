...
import { Settings2, SlidersHorizontal, Users, Book, ThumbsUp, ThumbsDown, X, Info } from 'lucide-react';
    ...
    _jsxDEV("div", { className: "container canto-page", style: { position: 'relative' }, children: [
      ...
      _jsxDEV("div", { className: "canto-header mb-4", children:
        _jsxDEV("div", { className: "canto-title-block", style: { width: '100%' }, children: [
          ...
          _jsxDEV("div", { className: "canto-meta-info", style: { display: 'flex', gap: '0.5rem', flexWrap: 'wrap', alignItems: 'center' }, children: [
            ...
            (() => {
              let badgeOffset = savedTransposition !== null && savedTransposition !== undefined ? savedTransposition : initialTransposition;
              let hasSavedTone = savedTransposition !== null && savedTransposition !== undefined;

              if (badgeOffset !== undefined && badgeOffset !== null && canto.tom_original !== '?') {
                ...
                return _jsxDEV("div", { style: { display: 'flex', alignItems: 'center', gap: '4px', marginLeft: '0.5rem' }, children: [
                  _jsxDEV("span", { style: { color: hasSavedTone ? '#15803d' : '#ca8a04', fontSize: '0.8rem', fontWeight: 'bold', marginRight: '4px' }, children: hasSavedTone ? "✅ Seu Tom:" : "Sugerido:" }, void 0, false),
                  _jsxDEV("span", { style: { background: hasSavedTone ? '#dcfce7' : '#e0f2fe', color: hasSavedTone ? '#166534' : '#0369a1', padding: '0.2rem 0.6rem', borderRadius: '12px', fontWeight: 'bold', fontSize: '0.85rem' }, children: ["🎸 ", badgeCapo.formaAcorde] }, void 0, true),
                  badgeCapo.capoCasa > 0 && _jsxDEV("span", { style: { background: hasSavedTone ? '#dcfce7' : '#fef3c7', color: hasSavedTone ? '#166534' : '#b45309', padding: '0.2rem 0.6rem', borderRadius: '12px', fontWeight: 'bold', fontSize: '0.85rem', display: 'flex', alignItems: 'center', gap: '4px' }, children: [
                    _jsxDEV("img", { src: capoIcon, alt: "Capo", style: { width: '14px', height: '14px', filter: hasSavedTone ? 'none' : 'hue-rotate(20deg) saturate(150%) brightness(0.8)' } }, void 0, false), `Capo ${badgeCapo.capoCasa}ª`
                  ] }, void 0, true)
                ] }, void 0, true);
              }
              return null;
      ...
      _jsxDEV("div", { className: "canto-desktop-grid", children: [
        _jsxDEV("div", { className: "canto-left-col", children: [
          ...
          user && <NotepadSection showNotes={showNotes} setShowNotes={setShowNotes} notes={notes} setNotes={setNotes} saveNotes={saveNotes} />
        ] }, void 0, true),

        _jsxDEV("div", { className: "canto-right-col", children: [
          _jsxDEV(TranspositionCard, {
            transposition: transposition,
