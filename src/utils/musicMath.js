export function hzToNoteName(freq) {
  ...
  const noteNames = ["Dó", "Dó#", "Ré", "Ré#", "Mi", "Fá", "Fá#", "Sol", "Sol#", "Lá", "Sib", "Si"];
...
export function getVoiceClassification(minFreq, maxFreq = null) {
  ...
  const ranges = [
    { name: 'Baixo', min: 80, max: 330 },
    { name: 'Barítono', min: 100, max: 400 },
    { name: 'Tenor', min: 130, max: 500 },
    { name: 'Contralto', min: 175, max: 700 },
    { name: 'Mezzo-Soprano', min: 220, max: 880 },
    { name: 'Soprano', min: 260, max: 1050 }
  ];
